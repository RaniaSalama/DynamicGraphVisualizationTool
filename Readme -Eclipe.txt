1- Top changing vertices and its variations:
	...
	To run top changing vertices and its variations, do the following from Eclipse:
		Creat new Java project (go to File -> New -> Java Project) and then add "src\server\TopChangingVerticesCalculator.java" to the project.
		...
		graph1File graph2File regionsNumber nodesNumPerRegion baisedk
		Where:
		...
		"data\Related Work Format\Food_graphs\Japan.txt" "data\Related Work Format\Food_graphs\North-African.txt" 10 16 5
...
2- Top changing vertices Exhaustive Search and its variations:
	...
	To run top changing vertices and its variations, do the following from Eclipse:
		Creat new Java project (go to File -> New -> Java Project) and then add "src\server\TopChangingVerticesExhaustiveCalculator.java" to the project.
		Then right click on the java file, choose Run As and then Run Configurations. In the opened window on the right, choose Arguments tab and in Program Arguments field, enter the following:
		graph1File graph2File regionsNumber nodesNumPerRegion baisedk
		Where:
			- graph1File is the file containing graph1 in the standard format, where each line represents a node in the following format:
...
3- Max Changing Radius + its variations:
	...
	To run max changing radius and its variations, do the following from Eclipse:
		Creat new Java project (go to File -> New -> Java Project) and then add "src\server\MaxChangingRadiusCalculator.java" to the project.
		Then right click on the java file, choose Run As and then Run Configurations. In the opened window on the right, choose Arguments tab and in Program Arguments field, enter the following:
		graph1File graph2File regionsNumber nodesNumPerRegion baisedk
		Where:
			- graph1File is the file containing graph1 in the standard format, where each line represents a node in the following format:
